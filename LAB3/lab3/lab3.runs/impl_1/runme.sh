...
HD_PWD='F:/SC2103/LAB3/lab3/lab3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log AM_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source AM_top.tcl -notrace
